...
namespace TownOfUs.Patches
{
    class Colors {
        ...
        public readonly static Color Psychic = new Color(0.67f, 0.67f, 1f, 1f);
        ...
        public readonly static Color Blind = new Color(0.67f, 0.67f, 0.67f, 1f);
        public readonly static Color Child = Color.white;
